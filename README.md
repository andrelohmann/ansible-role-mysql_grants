...
![Last test](https://github.com/andrelohmann/ansible-role-mysql_grants/actions/workflows/test.yml/badge.svg)
...
The default set of variables can be used to provision users and grants
